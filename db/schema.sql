...
CREATE TABLE IF NOT EXISTS stores (
    ...
    productivity_a INTEGER NOT NULL DEFAULT 24,
    productivity_b INTEGER NOT NULL DEFAULT 18,
    productivity_c INTEGER NOT NULL DEFAULT 12,
    productivity_other INTEGER NOT NULL DEFAULT 15,
    ...
    opening_staff_count INTEGER NOT NULL DEFAULT 1,
